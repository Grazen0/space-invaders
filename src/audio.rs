...
use crate::core::emulator::Sound as GameSound;
...
impl AudioManager {
    pub fn new(audio_subsystem: AudioSubsystem) -> Result<Self, String> {
        Ok(Self {
            ufo: device_from_wav(
                include_bytes!("../assets/audio/0.wav"),
                &audio_subsystem,
                true,
            )?,
            shoot: device_from_wav(
                include_bytes!("../assets/audio/1.wav"),
                &audio_subsystem,
                false,
            )?,
            player_die: device_from_wav(
                include_bytes!("../assets/audio/2.wav"),
                &audio_subsystem,
                false,
            )?,
            invader_die: device_from_wav(
                include_bytes!("../assets/audio/3.wav"),
                &audio_subsystem,
                false,
            )?,
            bomp1: device_from_wav(
                include_bytes!("../assets/audio/4.wav"),
                &audio_subsystem,
                false,
            )?,
            bomp2: device_from_wav(
                include_bytes!("../assets/audio/5.wav"),
                &audio_subsystem,
                false,
            )?,
            bomp3: device_from_wav(
                include_bytes!("../assets/audio/6.wav"),
                &audio_subsystem,
                false,
            )?,
            bomp4: device_from_wav(
                include_bytes!("../assets/audio/7.wav"),
                &audio_subsystem,
                false,
            )?,
            ufo_explode: device_from_wav(
                include_bytes!("../assets/audio/8.wav"),
                &audio_subsystem,
                false,
            )?,
        })
...
pub fn device_from_wav(
    ...
    audio_subsystem.open_playback(None, &audio_spec, move |spec| {
        ...
        .expect("could not initialize audio CVT");
